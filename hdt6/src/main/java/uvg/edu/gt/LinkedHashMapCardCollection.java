...
public class LinkedHashMapCardCollection implements CardCollection {
    // Mapa para almacenar el tipo de cada carta, manteniendo el orden de inserción
    private final Map<String, String> tiposCartas;
    // Mapa para almacenar la cantidad de cada carta en la colección, manteniendo el orden de inserción
    private final Map<String, Integer> coleccionCartas;

    // Constructor para inicializar los mapas
    public LinkedHashMapCardCollection() {
        this.tiposCartas = new LinkedHashMap<>();
        this.coleccionCartas = new LinkedHashMap<>();
    }
