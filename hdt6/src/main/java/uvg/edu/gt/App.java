...
public class App {
    public static void main(String[] args) {
            ...
            System.out.println("Elige la implementación del MAP que quieres: (1) HashMap, (2) TreeMap, (3) LinkedHashMap");
            ...
            switch (eleccion) {
                ...
                case 3:
                    ...
                    break;
                default:
                    System.out.println("Opción inválida. Se usará la implementación predeterminada (HashMap).");
                    coleccionCartas = new HashMapCardCollection();
            }

            try {
                BufferedReader lector = new BufferedReader(new FileReader("cards_desc.txt"));
                String linea;
